...
class juzViewBuilder extends StatefulWidget {
  juzViewBuilder({Key key, @required this.pages}) : super(key: key);
  final int pages;

  @override
  _juzViewBuilderState createState() => _juzViewBuilderState();
}

class _juzViewBuilderState extends State<juzViewBuilder> {
  /// My Document
  ...
  Future<PDFDocument> _getDocument() async {
    ...
    if (await hasSupport()) {
      _document = await PDFDocument.openAsset('assets/pdf/book.pdf');
      return _document;
    } else {
      throw Exception(
